...
class BM25Retriever:
    ...
    The index is built once at construction.  Query scoring is deterministic,
    including a chunk-id tie-breaker, which makes offline comparisons and
    replayed jobs stable.
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._tokens = {doc.chunk_id: tokenize(doc.text) for doc in self.documents}
        ...
        *,
        ...
        for term in query_terms:
            ...
            denominator = term_frequency + self.k1 * (
                1.0
                - self.b
                + self.b * length / self._average_length
